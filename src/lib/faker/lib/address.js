...
function Address (faker) {
  ...
  this.cityName = function() {
    return faker.random.arrayElement(faker.locales[faker.locale].address.city_name ?? faker.locales[faker.locale].address.city);
  }
  ...
  this.country = function () {
    if (faker.locale === 'en') {
      ...
      return faker.locales[faker.locale].address.default_country[0];
    }
  }
  ...
  this.state = function (useAbbr) {
    if (faker.locales[faker.locale].address.state && faker.locales[faker.locale].address.state.length > 0) {
      return faker.random.arrayElement(faker.locales[faker.locale].address.state);
    } else if (faker.locales[faker.locale].address.street_title && faker.locales[faker.locale].address.street_title.length > 0) {
      return faker.random.arrayElement(faker.locales[faker.locale].address.street_title);
    } else if (faker.locales[faker.locale].address.street_root && faker.locales[faker.locale].address.street_root.length > 0) {
      return faker.random.arrayElement(faker.locales[faker.locale].address.street_root);
    } else if (faker.locales[faker.locale].address.street && faker.locales[faker.locale].address.street.length > 0) {
      return faker.random.arrayElement(faker.locales[faker.locale].address.street);
    } else if (faker.locales[faker.locale].address.state && faker.locales[faker.locale].address.state.length === 0) {
      return faker.random.arrayElement(faker.locales[faker.locale].address.state);
    }
